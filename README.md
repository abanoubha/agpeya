...
Download Agpeya app
from [Google Play](https://play.google.com/store/apps/details?id=com.softwarepharaoh.agpeya).

You can see our updates and suggestions on [telegram](https://t.me/abanoubchan)
or [facebook](https://facebook.com/SWEAbanoubHanna).

## Why opensource ?

I created the app to be available to all people who need it, all the time, everywhere. I'd like to
create a developer community to maintain the app indefinitely.

The codebase is available
on [Github](https://github.com/abanoubha/agpeya), [GitLab](https://gitlab.com/abanoubha/agpeya),
and [CodeBerg](https://codeberg.org/abanoubha/agpeya).
...
- be available to almost all Android smartphones; support Android 5.1 (2014) up to Android 14 (2023,
  latest)
...
Agpeya app is open source, so you can write [issues](https://github.com/abanoubha/agpeya/issues) if
you want to __suggest__ anything or have a complaint about anything. If you are a software
developer, you can send [pull requests](https://github.com/abanoubha/agpeya/pulls).
